...
class Profile(models.Model):
    ...
    # for more clarity, maybe change the friends field to "Profile", instead of "User"
    ...
    def get_displayed_name(self):
        return self.first_name if self.first_name is not None and self.first_name != "" else self.user.username
    ...
    # saves the user slug as "firstname-lastname"
    # if there are 2 user with the same name a random string is appended to the string
